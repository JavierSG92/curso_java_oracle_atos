...
public class FicheroPersona implements IPersonaDAO {
    public static final String FICH = "C:\\Users\\USUARIO\\Desktop";
    ...
    { try {
        ObjectOutputStream escribFich = new ObjectOutputStream(new FileOutputStream(FICH + "\\persona.dat"));
    ...
    {  try {
        ObjectInputStream leyendoFich = new ObjectInputStream(new FileInputStream(FICH + "\\persona.dat"));
