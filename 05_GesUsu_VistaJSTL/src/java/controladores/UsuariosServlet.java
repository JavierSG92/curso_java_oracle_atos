...
public class UsuariosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Seleccionar los campos de login de los parámetros o de las ccokies
        ...
        if (ServicioUsuarios.getInstancia().validarLoginUsuario(email, password) == ServicioUsuarios.Resultado.Ok){
            ...
            //Usuario se está logueando bien. Creamos y mandamos las cookies al navegador
                ...
                switch (request.getMethod()) { 
                    case "POST": 
                        ...
                        switch(resultado){ 
                            case Ok: 
                                usuario = ServicioUsuarios.getInstancia().obtenerUno(email);
                                request.getSession().setAttribute("usuario", usuario); //Cargamos un JavaBeans
