...
public class ServicioUsuarios {
    ...
    public Resultado add(String nom, int edad, String email, String password) {

        if ( !nom.isEmpty() && edad > 18 && email != "" && password != "") {
            Usuario nuevoUsu = new Usuario(0, nom, edad, email, password);
    ...
    public Usuario validacionPasswd(String email, String password) {
